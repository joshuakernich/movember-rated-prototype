...
thread:[
	...
	{is:'question',iCorrect:2,p:['You’ll get over it.','Yeah man. You lost a good one.',"Sounds like you're feeling a lot of regret."],f:['Try and avoid being dismissive of how a man feels.','Maybe not a great time to rub salt in his wound.','Recognising the emotion the man is feeling is a great way to <b>validate</b>. This also helps nudge the conversation towards the man talking about his emotions.']},
	{is:'them',p:['Yeah, I guess I am.','Geting waves of sadness.','It’s pretty tough.']},
	{is:'question',iCorrect:2,p:['Gotta break the cycle, dude.','Let’s go out, get loose, and drink the pain away.','Yeah man. That’s to be expected. How have you been taking care of yourself?'],f:['Avoid judgement and jumping to conclusions.','There’s nothing terribly wrong with this. But maybe we can inspire more positive changes.','Normalising their reactions and encouraging action that may help them are great next steps.']},
